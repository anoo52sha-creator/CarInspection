...
const storage = new CloudinaryStorage({
  ...
  params: async (req, file) => {
    ...
    return {
      folder: "car-inspections",
      // Force 'raw' or 'image' depending on file, but 'auto' works if combined with 'upload'
      resource_type: isPdf ? "raw" : "image", 
      type: "upload", // This ensures the delivery type is public
      access_mode: "public",
      allowed_formats: ["jpg", "png", "jpeg", "pdf"],
      // Add this line to ensure PDFs are accessible without authentication
      flags: "attachment" 
    };
  },
});
